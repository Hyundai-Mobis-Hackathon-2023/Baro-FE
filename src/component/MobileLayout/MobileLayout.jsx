...
const MobileLayout = ({ children, color, bar, initial, animate, transition, darkShadow }) => (
  <Background>
    <Mobile color={color} initial={initial} animate={animate} transition={transition} darkShadow={darkShadow}>
      {bar && <ProgressBar />}
      {children}
    </Mobile>
  </Background>
